...
export function AdminNav({
  ...
  return (
    <header className="border-b border-hf-tan-dark bg-hf-white">
      <div className="mx-auto flex max-w-4xl flex-wrap items-center gap-x-6 gap-y-2 px-4 py-3 sm:px-6">
        <span className="flex items-center gap-2">
          ...
          <span className="hf-type-body hf-type-strong text-hf-green-dark">Admin</span>
        </span>
        <nav className="hf-type-body flex flex-1 flex-wrap gap-4">
          {LINK_DEFS.map((link) => (
            <Link
              key={link.href}
              href={link.href}
        ...
        <div className="hf-type-small flex items-center gap-3 text-text-muted">
