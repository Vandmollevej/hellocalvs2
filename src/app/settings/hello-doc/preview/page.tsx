  ...
  return (
    <div className="flex h-full min-h-0 flex-1 flex-col overflow-hidden bg-hf-white">
          ...
          {menuOpen && (
            <>
              ...
              <div className="absolute right-0 top-12 z-50 w-52 rounded-xl border bg-hf-white p-1 shadow-xl" style={{ borderColor: "var(--hf-color-line)" }}>
                <button type="button" className="hf-type-body w-full rounded-lg px-3 py-2.5 text-left hover:bg-hf-cream">
                  {t("helloDoc.preview.menuHelp")}
                </button>
                <button type="button" className="hf-type-body w-full rounded-lg px-3 py-2.5 text-left hover:bg-hf-cream">
                  {t("helloDoc.preview.menuView")}
                </button>
                <Link href="/profile/edit" className="hf-type-body block w-full rounded-lg px-3 py-2.5 text-left hover:bg-hf-cream">
                  {t("helloDoc.preview.menuMyDetails")}
                </Link>
                <button type="button" onClick={logOut} className="hf-type-body w-full rounded-lg px-3 py-2.5 text-left text-hf-red-dark hover:bg-hf-cream">
      ...
      <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain">
        ...
        {!error && !data && <p className="text-text-secondary hf-type-body p-4">{t("common.loading")}</p>}
          ...
          <div className="hf-page hf-page--sections md:flex-row md:items-start">
            ...
            <div className="min-w-0 flex-1">
              <div className="relative mb-4 ml-auto w-48">
                <select
                  className="hf-type-input h-10 w-full appearance-none rounded-[8px] border bg-hf-cream pl-3 pr-9 outline-none"
