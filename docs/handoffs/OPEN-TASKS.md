...
| 8b0a278f | Kropsmål med mand/kvinde-tegninger (fra hovedmappen), kort som på statistik | I gang | Ikonerne (mand/kvinde) er lavet og bruges overalt (BodyMeasure.tsx). Selve siden/kortene er ikke ændret |
