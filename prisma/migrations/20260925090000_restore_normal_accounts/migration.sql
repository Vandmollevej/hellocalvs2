...
-- AlterEnum
ALTER TYPE "WeightSource" ADD VALUE 'HEALTH_CONNECT';
...
-- AlterEnum
ALTER TYPE "HealthMetricSource" ADD VALUE 'HEALTH_CONNECT';
...
-- AlterTable
ALTER TABLE "products" ADD COLUMN     "privateOwnerId" TEXT;
...
-- AlterTable
ALTER TABLE "ingredient_requests" DROP COLUMN "replyInboxId",
ADD COLUMN     "privateProductId" TEXT;
...
-- AddForeignKey
ALTER TABLE "products" ADD CONSTRAINT "products_privateOwnerId_fkey" FOREIGN KEY ("privateOwnerId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
