...
ALTER TABLE "users" ADD COLUMN "autoExpandUncertainty" BOOLEAN NOT NULL DEFAULT false;

ALTER TABLE "registrations" ADD COLUMN "nutrientSnapshot" JSONB;
ALTER TABLE "registrations" ADD COLUMN "nutrientEstimatedSnapshot" JSONB;
ALTER TABLE "registrations" ADD COLUMN "nutrientToleranceSnapshot" JSONB;
